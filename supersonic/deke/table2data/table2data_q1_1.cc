...
int main(int argc, char* argv[]) {
	Table2Data_Q1_1::Date("/home/fish/data/ssb/date.tbl", "../storage/date_q1_1.tbl");
	Table2Data_Q1_1::Lineorder("/home/fish/data/ssb/lineorder.tbl", "../storage/lineorder_q1_1.tbl");
	return 0;
}

...
int main(int argc, char* argv[]) {
	Table2Data_Q2_3::Supplier("/home/fish/data/ssb/supplier.tbl", "../storage/supplier_q2_3.tbl");
	Table2Data_Q2_3::Part("/home/fish/data/ssb/part.tbl", "../storage/part_q2_3.tbl");
	Table2Data_Q2_3::Date("/home/fish/data/ssb/date.tbl", "../storage/date_q2_3.tbl");
	Table2Data_Q2_3::Lineorder("/home/fish/data/ssb/lineorder.tbl", "../storage/lineorder_q2_3.tbl");
	return 0;
}

...
int main(int argc, char* argv[]) {
	Table2Data_Q3_2::Customer("/home/fish/data/ssb/customer.tbl", "../storage/customer_q3_2.tbl");
	Table2Data_Q3_2::Supplier("/home/fish/data/ssb/supplier.tbl", "../storage/supplier_q3_2.tbl");
	Table2Data_Q3_2::Date("/home/fish/data/ssb/date.tbl", "../storage/date_q3_2.tbl");
	Table2Data_Q3_2::Lineorder("/home/fish/data/ssb/lineorder.tbl", "../storage/lineorder_q3_2.tbl");
	return 0;
}

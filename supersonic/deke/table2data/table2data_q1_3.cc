...
#include "deke/include/ssb_q1_3.h"
...
int main(int argc, char* argv[]) {
	Table2Data_Q1_3::Date("/home/fish/data/ssb/date.tbl", "../storage/date_q1_3.tbl");
	Table2Data_Q1_3::Lineorder("/home/fish/data/ssb/lineorder.tbl", "../storage/lineorder_q1_3.tbl");
	return 0;
}

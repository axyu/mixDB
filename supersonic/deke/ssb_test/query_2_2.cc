...
const View& LineorderView(vector<vector<bool>>& storage_map) {
	...
	TupleSchema lineorder_schema = SSB_Q2_2_Schema::lineorder();	
	File* fp = File::OpenOrDie("../../storage/lineorder_q2_2.tbl", "r");
...
const View* CustomerView() {
	...
	TupleSchema customer_schema = SSB_Q2_2_Schema::customer();
	File* fp = File::OpenOrDie("../../storage/customer_q2_2.tbl", "r");
...
int main() {
	...
	TupleSchema fact_schema = SSB_Q2_2_Schema::lineorder();
	vector<TupleSchema> dimension_schemas;
	TupleSchema dimension1_schema = SSB_Q2_2_Schema::supplier();
	TupleSchema dimension2_schema = SSB_Q2_2_Schema::part();
	TupleSchema dimension3_schema = SSB_Q2_2_Schema::date();

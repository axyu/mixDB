...
const View& LineorderView(vector<vector<bool>>& storage_map) {
	int lineorder_row_count = 300005811;//6001215;
	TupleSchema lineorder_schema = SSB_Q4_1_Schema::lineorder();	
	File* fp = File::OpenOrDie("../../storage/lineorder.tbl", "r");
...
const View* CustomerView() {
	int customer_row_count = 1500001;//30001;
...
const View* SupplierView() {
	int supplier_row_count = 100001;//2001;
...
const View* PartView() {
	int date_row_count = 1200001;//200001;
...
int main() {
	...
	TupleSchema dimension1_schema = SSB_Q4_1_Schema::customer();
	TupleSchema dimension2_schema = SSB_Q4_1_Schema::supplier();
	TupleSchema dimension3_schema = SSB_Q4_1_Schema::part();
	TupleSchema dimension4_schema = SSB_Q4_1_Schema::date();

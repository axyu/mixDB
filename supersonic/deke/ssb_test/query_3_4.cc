...
#include "deke/include/ssb_q3_4.h"
...
const View& LineorderView(vector<vector<bool>>& storage_map) {
	...
	TupleSchema lineorder_schema = SSB_Q3_4_Schema::lineorder();	
	File* fp = File::OpenOrDie("../../storage/lineorder_q3_4.tbl", "r");
...
const View* CustomerView() {
	...
	TupleSchema customer_schema = SSB_Q3_4_Schema::customer();
	File* fp = File::OpenOrDie("../../storage/customer_q3_4.tbl", "r");
...
const View* SupplierView() {
	...
	TupleSchema supplier_schema = SSB_Q3_4_Schema::supplier();
	File* fp = File::OpenOrDie("../../storage/supplier_q3_4.tbl", "r");
...
const View* DateView() {
	...
	TupleSchema date_schema = SSB_Q3_4_Schema::date();
	File* fp = File::OpenOrDie("../../storage/date_q3_4.tbl", "r");
...
int main() {
	...
	vector<double> element = {1.0 / 125.0, 1.0 / 125.0, 1.0 / 84.0};
	selectivity.push_back(element);

	TupleSchema fact_schema = SSB_Q3_4_Schema::lineorder();
	vector<TupleSchema> dimension_schemas;
	TupleSchema dimension1_schema = SSB_Q3_4_Schema::customer();
	TupleSchema dimension2_schema = SSB_Q3_4_Schema::supplier();
	TupleSchema dimension3_schema = SSB_Q3_4_Schema::date();

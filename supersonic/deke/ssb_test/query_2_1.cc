...
const View* CustomerView() {
	...
	TupleSchema customer_schema = SSB_Q2_1_Schema::customer();
	File* fp = File::OpenOrDie("../../storage/customer_q2_1.tbl", "r");
...
int main() {
	...
	TupleSchema dimension1_schema = SSB_Q2_1_Schema::supplier();
	TupleSchema dimension2_schema = SSB_Q2_1_Schema::part();
	TupleSchema dimension3_schema = SSB_Q2_1_Schema::date();

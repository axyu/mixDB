...
int main() {
	...
	TupleSchema dimension1_schema = SSB_Q4_2_Schema::customer();
	TupleSchema dimension2_schema = SSB_Q4_2_Schema::supplier();
	TupleSchema dimension3_schema = SSB_Q4_2_Schema::part();
	TupleSchema dimension4_schema = SSB_Q4_2_Schema::date();
	...
	std::cout << " supplier schema " << dimension2_schema.GetHumanReadableSpecification() << std::endl;	

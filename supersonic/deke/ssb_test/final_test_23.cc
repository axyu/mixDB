...
int main(int argc, char** argv) {
	if(argc != 4) {
		std::cout << "./this q2_run_time q3_run_time memory_width" << std::endl;
		exit(-1);
	}
	...
	query_proportion.push_back(q2_run_time * 1.0 / (q2_run_time + q3_run_time));
	query_proportion.push_back(q3_run_time * 1.0 / (q2_run_time + q3_run_time));
	...
	vector<double> element1 = {-1, 0.4, 0.5, 0.5};
	vector<double> element2 = {0.4, -1, 0.5, 0.5};

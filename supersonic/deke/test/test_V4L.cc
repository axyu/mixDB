...
int main() {
	...
	vector<int> column_width = {32, 40, 8, 48, 80, 4};
	...
	vector<int> key_column_width = {32, 48, 8, 48, 80};
...
*/
	...
	vector<vector<int>> classic_filter_order_q1(100, {1, 0, 2, 3, 4});
	vector<vector<int>> classic_filter_order_q2(100, {0, 2, 1, 3, 4});
	vector<vector<int>> classic_filter_order_q3(100, {2, 0, 1, 3, 4});
